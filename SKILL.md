...
- 60% of outputs required revision
- Responses were generic and overly safe
- Formatting was inconsistent

After implementation:

- First-pass success rate increased to 94%
- Outputs became specific and detailed
- Structure remained consistent every time
